...
function unique(values) {
    return [...new Set(values.filter((value) => Boolean(value && value.trim())).map((value) => value.trim()))];
}
...
export function getAllowedLocalPathRoots() {
...
export function preferredPythonCommand() {
    return pythonCommandCandidates()[0] ?? (isWindows ? "python" : "python3");
}
export function tesseractCommandCandidates() {
    return unique([
...
export function fontForgeCommandCandidates() {
    return unique([
