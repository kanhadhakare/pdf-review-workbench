...
const DEFAULT_JAVA_BIN = process.env.JAVA_BIN
    ...
    || "java";
function buildUnavailableManifest(sourcePdf, message) {
    return {
        sourcePdf,
        engine: "pdfbox",
        status: "unavailable",
...
function buildFailedManifest(sourcePdf, message) {
    return {
        sourcePdf,
        engine: "pdfbox",
        status: "failed",
...
function normalizeManifest(manifest, sourcePdf) {
    return {
        sourcePdf,
        engine: "pdfbox",
...
export async function extractFontsWithPdfBox(jobId, sourcePdf) {
