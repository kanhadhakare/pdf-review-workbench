...
import { type TrainingStatus } from "@pdf-review-workbench/shared";
...
const scriptPath = path.resolve("E:/pdf-review-workbench/apps/api/src/scripts/train_classifiers.py");
